...
const EDUCATION = [
  {
    ...
    details: [
      'Current CGPA: 8.5',
      'Relevant Coursework: Data Structures & Algorithms, Object-Oriented Programming, Pattern Recognition, Computer Networks',
    ],
  },
];
...
const PROJECTS = [
  ...
  {
    title: 'KinOrbia',
    description: 'A NextJS application for film enthusiasts to discover movies, track watchlists, and engage with a vibrant community, featuring responsive design and interactive elements to enhance user experience.',
    tags: ['NextJS', 'Tailwind-CSS', 'MongoDB'],
    image: 'https://images.pexels.com/photos/7991486/pexels-photo-7991486.jpeg',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1695697478813-9cd8058712e7?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8YmVhdXRpZnVsJTIwd2VhdGhlcnxlbnwwfHwwfHx8MA%3D%3D',
